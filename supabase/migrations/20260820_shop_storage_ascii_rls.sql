...
--
-- Folder format:
--   shop-<UTF8 bytes of shop_id encoded as lowercase hex>
--
-- This keeps business-facing shop_id unchanged while avoiding Supabase
-- Storage InvalidKey errors for Thai/non-ASCII shop IDs.
