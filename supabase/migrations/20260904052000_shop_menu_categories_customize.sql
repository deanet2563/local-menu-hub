...
-- Generated for Shop Native Phase 1. Tables are tenant-scoped by shop_id and preserve history via soft enable/disable.
...
-- Reuse the existing SECURITY DEFINER helper to avoid cross-table RLS recursion.
