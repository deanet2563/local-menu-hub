...
export function BundleConfigurator({
  ...
  return (
    <div className="customer-bottom-safe-padding fixed inset-0 z-[70] flex items-end justify-center bg-black/40 sm:items-center sm:p-4" role="dialog" aria-modal="true">
