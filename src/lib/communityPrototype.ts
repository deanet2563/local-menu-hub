...
export const COMMUNITY_PROTOTYPE_COMMUNITIES: CommunityPrototypeCommunity[] = [
  {
    ...
    boundaryLabel: "Sammakorn-first pilot",
...
export const COMMUNITY_PROTOTYPE_POSTS: CommunityPrototypePost[] = [
  {
    ...
    body: "ข้อมูลในหน้านี้เป็น fixture สำหรับ prototype เท่านั้น ยังไม่ใช่ประกาศจริงจากนิติหรือผู้ดูแล",
...
export const COMMUNITY_PROTOTYPE_MARKETPLACE: CommunityPrototypeMarketplaceListing[] = [
  ...
  },
  {
    ...
    summary: "ตัวอย่าง listing แยกจากระบบสั่งอาหาร ไม่มีตะกร้าหรือชำระเงิน",
    priceLabel: "฿900",
    status: "reserved",
  ...
  },
  {
    ...
    summary: "ติดต่อผ่านช่องทางชุมชนในอนาคต รอบนี้เป็น prototype เท่านั้น",
    priceLabel: "แบ่งปัน",
    status: "active",
    ownerLabel: "สมาชิกในชุมชน",
  },
...
export const COMMUNITY_PROTOTYPE_MAP_ENTRIES: CommunityPrototypeMapEntry[] = [
  {
    ...
    precisionLabel: "ตำแหน่ง exact ได้เพราะเป็น business opt-in",
    visibilityNote: "คืนเฉพาะ field allowlist สำหรับ public directory",
  },
  {
    id: "map-park",
    communityId: "sammakorn",
    ...
    precisionLabel: "ตำแหน่ง public/approved",
    visibilityNote: "ใช้สำหรับ discovery โดยไม่เปิดข้อมูลสมาชิก",
  },
  {
    id: "map-member-note",
    communityId: "sammakorn",
    ...
    category: "member-only note",
    locationLabel: "ระบุเป็นโซน ไม่ใช่บ้านสมาชิก",
    precisionLabel: "approximate location",
    visibilityNote: "เห็นเฉพาะสมาชิก community เดียวกัน",
  },
];
