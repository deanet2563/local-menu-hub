...
import {
  isLocalCommunityPrototypeAuthBypassActive,
  isPreviewCheckoutMapAuthBypassActive,
  isPublicCommunityFixturePreviewAuthBypassActive,
...
export function initLiff(): Promise<void> {
  if (isLocalCommunityPrototypeAuthBypassActive()) return Promise.resolve();
  if (isPublicCommunityFixturePreviewAuthBypassActive()) return Promise.resolve();
...
export async function getAccessToken(): Promise<string> {
  if (isLocalCommunityPrototypeAuthBypassActive()) return "";
  if (isPublicCommunityFixturePreviewAuthBypassActive()) return "";
