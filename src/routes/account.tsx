...
function AccountPage() {
  ...
  if (!id)
    return (
      <div className="customer-bottom-safe-padding min-h-screen bg-[#f7f7f3] p-6 text-center text-sm text-slate-700">
        🔒 กรุณาเปิดหน้านี้ผ่าน LINE เพื่อเข้าสู่ระบบ
      </div>
    );

  return (
    <div className="customer-bottom-safe-padding min-h-screen bg-[#f7f7f3] px-4 py-5 text-slate-900"><div className="mx-auto max-w-md space-y-4">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-slate-950">บัญชี</h1>
        <p className="mt-1 text-sm font-semibold text-emerald-700">MyTree ของฉัน</p>
      </div>
