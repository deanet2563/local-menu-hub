        ...
        {pickedUpState && (
          <View style={styles.proofCard}>
            ...
            <Text style={styles.proofText}>
              หลังส่งอาหารให้ลูกค้า ให้ถ่ายรูปหลักฐาน ระบบจะเก็บรูปใน private Storage และ backend จะปิดงานเมื่อยืนยันว่า Rider ที่ถูก assign เป็นผู้ส่งรูปหลัง Pickup เท่านั้น
            </Text>
            <Pressable
              accessibilityRole="button"
